          ...
          <div class="produit-carte">
            ...
            <div class="produit-corps" style="padding: 12px 10px;">
              ...
              <div class="produit-actions" style="margin-top: 12px; display: flex; gap: 8px; align-items: center;">
                ...
                <button class="btn btn-orange" style="flex: 1; padding: 0; height: 34px; font-size: 0.8rem; border-radius: 6px; display: flex; align-items: center; justify-content: center; gap: 6px; white-space: nowrap;" onclick="ajouterAuPanier(${p.id}, '${p.nom.replace(/'/g, "\\'")}', ${p.prix}, '${image}', ${p.commerce_id}, '${nomBoutique.replace(/'/g, "\\'")}', '${photoBoutique}')">
